package vip.chentianxiang.middleware.whitelist;
...
public class DoJoinPoint {
    ...
    @Pointcut("@annotation(vip.chentianxiang.middleware.whitelist.annotation.DoWhiteList)")
